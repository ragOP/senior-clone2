...
const Terms = () => {
  return (
    ...
    <p className="title">Terms and Conditions for nationwidebenefits.net</p>
    </div>
    </div>
    ...
    <li>
    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to nationwidebenefits.net., 25 SE 2nd Ave Ste 550 PMB 63 Miami, FL 33131.</p>
    </li>
    <li>
    ...
    <li>
    <p><strong>Website</strong> refers to nationwidebenefits.net., accessible from <a href="www.nationwidebenefits.net" rel="external nofollow noopener" target="_blank">https://www.nationwidebenefits.net</a></p>
    </li>
    <li>
